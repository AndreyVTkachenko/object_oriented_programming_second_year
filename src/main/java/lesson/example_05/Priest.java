...
public class Priest {
    ...
    public Priest() {
        this(String.format(HERO_PRIEST_D, ++Priest.number),
                Priest.r.nextInt(101) + 100,  // Генерация числа от 100 до 200
                Priest.r.nextInt(101) + 50);  // Генерация числа от 50 до 150
    }

    public int Attack() {
        int damage = Priest.r.nextInt(11) + 20;  // Генерация числа от 20 до 30
