...
public class Ex002_Game {
    public static void main(String[] args) {
        ...
        Olympiad<Intern> o = new Olympiad<Intern>(team1, team2);
        o.start();
        System.out.println("st1 vs st2");

        // #region
        Team<String> st1 = new Team<String>("string team 1");
        Team<String> st2 = new Team<String>("string team 1");
